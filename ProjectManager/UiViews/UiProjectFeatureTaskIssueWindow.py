...
class Ui_ProjectFeatureTaskIssueWindow(object):
    def setupUi(self, ProjectFeatureTaskIssueWindow):
        ...
        self.TaskCompleteScrollAreaContents.setGeometry(QRect(0, 0, 380, 512))
        ...
        self.TaskInProgressScrollAreaContents.setGeometry(QRect(0, 0, 382, 514))
        ...
        self.TaskScrollAreaContents.setGeometry(QRect(0, 0, 382, 514))
        ...
        self.IssueScrollAreaContents.setGeometry(QRect(0, 0, 589, 229))
        ...
        self.IssueCompleteScrollAreaContents.setGeometry(QRect(0, 0, 588, 229))
