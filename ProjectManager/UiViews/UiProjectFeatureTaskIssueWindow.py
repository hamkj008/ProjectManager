...
class Ui_ProjectFeatureTaskIssueWindow(object):
    def setupUi(self, ProjectFeatureTaskIssueWindow):
        ...
        self.TaskCompleteScrollAreaContents.setGeometry(QRect(0, 0, 380, 560))
        ...
        self.TaskInProgressScrollAreaContents.setGeometry(QRect(0, 0, 382, 562))
        ...
        self.TaskScrollAreaContents.setGeometry(QRect(0, 0, 382, 562))
        ...
        self.IssueScrollAreaContents.setGeometry(QRect(0, 0, 589, 554))
        ...
        self.IssueCompleteScrollAreaContents.setGeometry(QRect(0, 0, 588, 554))
        ...
        sizePolicy2.setHeightForWidth(self.DescriptionScrollArea.sizePolicy().hasHeightForWidth())
        self.DescriptionScrollArea.setSizePolicy(sizePolicy2)
        self.DescriptionScrollArea.setMinimumSize(QSize(0, 150))
        ...
        self.DescriptionScrollAreaContents.setGeometry(QRect(0, 0, 1210, 148))
        self.verticalLayout_10 = QVBoxLayout(self.DescriptionScrollAreaContents)
        ...
        self.horizontalLayout_11 = QHBoxLayout(self.DescriptionFrame)
        ...
        self.horizontalLayout_11.addWidget(self.DescriptionTextLabel)
